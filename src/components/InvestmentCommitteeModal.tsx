...
export const InvestmentCommitteeModal: React.FC<InvestmentCommitteeModalProps> = ({
  ...
  const challenges: CommitteeChallenge[] = [
    {
      id: "challenge-1",
      theme: "1. Şüphe: Kârlılığın Ortalamaya Dönüşü (Mean Reversion Risk)",
      question: `${dossier.companyName}'in %${fin.roicPercent} seviyesindeki ROIC oranı sektör ortalamasının çok üzerinde. Ekonomik teoride yüksek kârlar rakipleri bir mıknatıs gibi çeker. Yeni girenlerin fiyat kırarak bu kârı 3 yıl içinde %${dossier.financials.wacc} seviyesine indirmesini engelleyecek tek somut bariyer nedir?`,
      skepticalReasoning: "Tarihsel veriler şirketlerin %80'inin 5 yıl içinde ortalama getiriye gerilediğini göstermektedir.",
    },
    {
      id: "challenge-2",
      theme: "2. Şüphe: Fiyatlama Gücü ve Tüketici İkamesi (WTP Erosion)",
      question: `Analizinizde ${dossier.competitiveAdvantage.primaryType === "tüketici_avantajı" ? "tüketici avantajını ve fiyatlama gücünü" : "maliyet liderliğini"} öne sürmüşsünüz. Enflasyonist bir ortamda veya ucuz dijital/yapay zeka ikameleri ortaya çıktığında müşteriler neden %10-15 daha pahalıya bu şirketten almaya devam etsin?`,
      skepticalReasoning: "Müşteri sadakati genellikle sadece daha ucuz bir alternatif çıkana kadar sürer.",
    },
    {
      id: "challenge-3",
      theme: "3. Şüphe: Sermaye Tahsisi & CAP Süresi Gerçekçiliği",
      question: `${dossier.sustainability.estimatedCapYears} yıllık bir Rekabetçi Avantaj Dönemi (CAP) öngörmüşsünüz. Yönetim kurulu biriken serbest nakit akımını pahalı satın almalarla veya kârsız projelerle heba ederse (Değer Yıkımı) bu hendek nasıl korunacak?`,
      skepticalReasoning: "Pek çok geniş hendekli şirket kötü sermaye dağıtımı (kötü M&A) yüzünden değer yok etmiştir.",
    },
  ];
  ...
  const [evaluationResult, setEvaluationResult] = useState<{
    defenseScore: number;
    verdict: "ONAYLANDI (Geniş Hendek Onayı)" | "ŞARTLI ONAY (Dar Hendek)" | "EK İNCELEME GEREKLİ";
    feedback: string;
  } | null>(null);
      ...
      {isOpen && (
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-amber-500/20 text-amber-300 border border-amber-500/30 flex items-center gap-1">
                <ShieldAlert className="w-3.5 h-3.5 text-amber-400" /> Yatırım Komitesi Simülasyonu
              </span>
            ...
            <h2 className="text-lg sm:text-xl font-extrabold tracking-tight">
              Şeytanın Avukatı (Devil's Advocate): Tezinizi Savunun
            </h2>
          </div>
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-slate-800 dark:text-slate-200">
          <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/50 p-4 rounded-2xl text-xs text-amber-900 dark:text-amber-200 leading-relaxed">
            <strong>🏛️ Komite Bildirisi:</strong> Bir analist olarak göreviniz sadece şirketi övmek değildir. Aşağıdaki 3 kuşkucu soruya vereceğiniz analitik yanıtlar, tezinizin sağlamlığını belirleyecektir.
          </div>
              ...
              >
                <div className="space-y-1">
                  ...
                  <p className="text-[11px] text-slate-500 italic">
                    💡 <em>Komitenin Gerekçesi: {c.skepticalReasoning}</em>
                  </p>
                </div>
                ...
                <div>
                  <textarea
                    ...
                    placeholder="Tezinizi ve şirket içi somut savunma kanıtlarınızı buraya yazın..."
            ...
            <div className="p-6 rounded-3xl bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800 space-y-4 animate-in fade-in duration-300">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <span className="text-[10px] font-bold text-slate-500 uppercase">Savunma Gücü</span>
                </div>
              </div>
          ...
          <div className="p-4 sm:p-6 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/80 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            >
              ...
              <span>{isEvaluating ? "Komite İnceliyor..." : "Savunmayı Komiteye Sun & Puanla"}</span>
            </button>
          </div>
        </motion.div>
      </div>
