...
const TOUR_STEPS: TourStep[] = [
  ...
  {
    id: "step-4-company-audit",
    stepNumber: 4,
    title: "4. Durak: Şirket Analiz Stüdyosu & Yatırım Komitesi",
  ...
  },
  {
    id: "step-5-duel",
    stepNumber: 5,
    title: "5. Durak: Hendek Düellosu & Kıyaslama",
  ...
  {
    id: "step-6-spaced-rep",
    stepNumber: 6,
    title: "6. Durak: Aralıklı Tekrarlama (SM-2 Flashcards)",
    badge: "KALICI HAFIZA",
    targetTab: "spaced-repetition",
    tabName: "Aralıklı Tekrarlama",
    icon: Repeat,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl w-full max-w-3xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="p-6 border-b border-slate-200 dark:border-slate-800 bg-gradient-to-r from-indigo-50/70 via-purple-50/40 to-white dark:from-slate-800 dark:via-slate-800/80 dark:to-slate-900 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-full bg-indigo-100 dark:bg-indigo-900/60 text-indigo-700 dark:text-indigo-300">
        ...
        <div className="flex items-center gap-1.5 px-6 py-3 bg-slate-50/80 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800 overflow-x-auto scrollbar-none shrink-0">
          {TOUR_STEPS.map((s, idx) => (
            ...
            >
              ...
              {idx < currentStepIndex && <CheckCircle2 className="w-3 h-3 text-emerald-500 shrink-0" />}
            </button>
          ))}
        </div>
